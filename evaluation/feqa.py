...
class FEQA(object):
    def __init__(self, squad_dir='./evaluation/qa_models/squad1.0', bart_qa_dir='./evaluation/bart_qg/checkpoints/', use_gpu=False):
        self.qg_model = BARTModel.from_pretrained(
            bart_qa_dir,
            checkpoint_file = 'checkpoint_best-002.pt'
            )
